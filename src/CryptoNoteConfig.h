...
const unsigned UPGRADE_VOTING_THRESHOLD                      = 85;   // percent
const uint32_t UPGRADE_VOTING_WINDOW                         = EXPECTED_NUMBER_OF_BLOCKS_PER_DAY * 2 / 3;  // blocks
const uint32_t UPGRADE_WINDOW                                = 50;  // blocks
