...
public:
  ...
  bool setFeePercent(const double fee_percent);
...
private:
  ...
  bool on_get_fee_info(const COMMAND_RPC_GET_FEE_INFO::request& req, COMMAND_RPC_GET_FEE_INFO::response& res);
  ...
  bool f_on_blocks_limited_json(const F_COMMAND_RPC_GET_BLOCKS_LIST::request& req, F_COMMAND_RPC_GET_BLOCKS_LIST::response& res);
